 ...
 */
public class CommercialTowerBuilder implements Builder { 
	...
	public CommercialTower getResult() {
		return new CommercialTower(foundation, colCount, beamCount, wallCount, roofing, type, storyCount, roomCount, doorCount);
	}
